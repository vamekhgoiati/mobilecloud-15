...
public class ContentProviderTimeoutCache
    ...
    private int putValues(String acronym,
        ...
        for (int i = 0; i < longForms.size(); i++) {
        	...
        	cvArray[i] = createContentValues(acronym, longForms.get(i), expirationTime);
        }
    ...
    private ContentValues createContentValues(String acronym,
			AcronymExpansion acronymExpansion, Long expirationTime) {
